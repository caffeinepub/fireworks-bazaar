...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: Category, arg5: string, arg6: string, arg7: bigint, arg8: bigint, arg9: boolean): Promise<ProductId> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, arg1, arg2, arg3, to_candid_Category_n1(this._uploadFile, this._downloadFile, arg4), arg5, arg6, arg7, arg8, arg9);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async listByCategory(arg0: Category): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.listByCategory(to_candid_Category_n1(this._uploadFile, this._downloadFile, arg0));
    ...
    async listInStock(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.listInStock();
                return from_candid_vec_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        effectDuration: value.effectDuration,
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "Novelty" in value ? Category.Novelty : "Bombs" in value ? Category.Bombs : "Sparklers" in value ? Category.Sparklers : "FlowerPots" in value ? Category.FlowerPots : "GroundChakkar" in value ? Category.GroundChakkar : "AerialShots" in value ? Category.AerialShots : "Rockets" in value ? Category.Rockets : value;
}
...
function to_candid_variant_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.Novelty ? {
        Novelty: null
    } : value == Category.Bombs ? {
        Bombs: null
    } : value == Category.Sparklers ? {
        Sparklers: null
    } : value == Category.FlowerPots ? {
        FlowerPots: null
    } : value == Category.GroundChakkar ? {
        GroundChakkar: null
    } : value == Category.AerialShots ? {
        AerialShots: null
    } : value == Category.Rockets ? {
        Rockets: null
    } : value;
}
